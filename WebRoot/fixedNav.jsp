...
<div id="fixedMenu">
	...
	<div id="searchFormOuter">
    	<form class="formWrapper" action="/searchBooks">
        	<input id="search" name="search" type="text" placeholder="search books...." required="required" />
    ...
    <div id="navBarRight">
		...
		<a href="shoppingcart1.jsp"><div class="navBtns" id="showCart">
        ...
        <a><div id="my_account" class="navBtns">
	...
	<%--drop down starts here --%>
			<div id="drop">
				<a href="showAccountServlet" ><div id="login" class="navBtns">
...
<div id="light">
		...
		<form method="post" action="UserController?action=login" name="loginfrm">
        <h1>Can I See Some ID?</h1>
            ...
            <input type="button" value="Sign Up" class="frmBtn" onclick="javascript:location.href='registrationForm.jsp'" />
            <div class="clear"></div>
		</form>
